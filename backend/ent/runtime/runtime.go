...
func init() {
	...
	// apikeyDescGroupBindingsEnabled is the schema descriptor for group_bindings_enabled field.
	apikeyDescGroupBindingsEnabled := apikeyFields[4].Descriptor()
	// apikey.DefaultGroupBindingsEnabled holds the default value on creation for the group_bindings_enabled field.
	apikey.DefaultGroupBindingsEnabled = apikeyDescGroupBindingsEnabled.Default.(bool)
	// apikeyDescGroupBindings is the schema descriptor for group_bindings field.
	apikeyDescGroupBindings := apikeyFields[5].Descriptor()
	// apikey.DefaultGroupBindings holds the default value on creation for the group_bindings field.
	apikey.DefaultGroupBindings = apikeyDescGroupBindings.Default.([]domain.APIKeyGroupBinding)
