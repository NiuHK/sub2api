...
func (_u *APIKeyUpdate) SetGroupBindingsEnabled(v bool) *APIKeyUpdate {
	_u.mutation.SetGroupBindingsEnabled(v)
	return _u
}

// SetNillableGroupBindingsEnabled sets the "group_bindings_enabled" field if the given value is not nil.
func (_u *APIKeyUpdate) SetNillableGroupBindingsEnabled(v *bool) *APIKeyUpdate {
	if v != nil {
		_u.SetGroupBindingsEnabled(*v)
	}
	return _u
}
...
func (_u *APIKeyUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.GroupBindingsEnabled(); ok {
...
// SetGroupBindingsEnabled sets the "group_bindings_enabled" field.
func (_u *APIKeyUpdateOne) SetGroupBindingsEnabled(v bool) *APIKeyUpdateOne {
	_u.mutation.SetGroupBindingsEnabled(v)
	return _u
}

// SetNillableGroupBindingsEnabled sets the "group_bindings_enabled" field if the given value is not nil.
func (_u *APIKeyUpdateOne) SetNillableGroupBindingsEnabled(v *bool) *APIKeyUpdateOne {
	if v != nil {
		_u.SetGroupBindingsEnabled(*v)
	}
	return _u
