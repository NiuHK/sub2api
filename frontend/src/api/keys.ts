...
export async function create(
  ...
  groupBindings?: { enabled: boolean; bindings: import('@/types').ApiKeyGroupBinding[] }
): Promise<ApiKey> {
  ...
  if (groupBindings) {
    payload.group_bindings_enabled = groupBindings.enabled
    payload.group_bindings = groupBindings.bindings
  }
